...
<template>
    <ul class="ml-1 md:mt-8 mt-3 flex items-center">
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" title="GitHub"><span
                    class="sr-only">GitHub</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" title="LinkedIn"><span
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" title="CodePen"><span
                    class="sr-only">CodePen</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" title="Instagram"><span
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" title="Goodreads"><span
