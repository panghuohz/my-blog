...
<template>
    <ul class="ml-1 md:mt-8 mt-3 flex items-center" aria-label="Social media">
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" aria-label="CodePen (opens in a new tab)" title="CodePen"><span
        ...
        <li class="mr-5 shrink-0 text-xs"><a class="block hover:text-slate-200" href="" target="_blank"
                rel="noreferrer noopener" aria-label="Instagram (opens in a new tab)" title="Instagram"><span
