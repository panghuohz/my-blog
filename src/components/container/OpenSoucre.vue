...
<template>
    <section>
        <div class="xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto w-full pb-[10rem] overflow-hidden relative">
            <svg class="absolute top-[-180px] w-full z-0 xl:block hidden" width="1793" height="1269"
                viewBox="0 0 1793 1269" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-79e4b1cc="">
                <path
                    ...
                    stroke="url(#linear-sponsor-lines)" data-v-79e4b1cc=""></path>
                <defs data-v-79e4b1cc="">
                    <linearGradient id="linear-sponsor-lines" x1="0" y1="0" x2="0" y2="1200"
                        gradientUnits="userSpaceOnUse" data-v-79e4b1cc="">
                        <stop offset="0.1" stop-color="#1b1c20" stop-opacity="0" data-v-79e4b1cc=""></stop>
                        <stop offset="0.35" stop-color="#1b1c20" data-v-79e4b1cc=""></stop>
                        <stop offset="0.55" stop-color="#1b1c20" stop-opacity="0.2" data-v-79e4b1cc=""></stop>
                        <stop offset="0.6" stop-color="#1b1c20" stop-opacity="0.2" data-v-79e4b1cc=""></stop>
                        <stop offset="0.7" stop-color="#1b1c20" data-v-79e4b1cc=""></stop>
                        <stop offset="1" stop-color="#1b1c20" stop-opacity="0" data-v-79e4b1cc=""></stop>
                    </linearGradient>
                </defs>
            </svg>
